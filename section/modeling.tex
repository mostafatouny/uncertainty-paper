...
\textbf{Definition.} For a subset of vertices $S = \{ v_1, \dots, v_k \} \subseteq V(G)$ and a set of random variables distributions $\{ \mu_{X_1}, \dots, \mu_{X_k} \}$, an uncertain zone is a function $U$
$$
...
\textbf{Definition.} An uncertain environment is a tuple $(G, \{ U_i \})$, of a digraph $G$ and uncertain zones $U_i$.
