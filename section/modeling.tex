...
\textbf{Definition.} For a subset of vertices $S = \{ v_1, \dots, v_k \} \subseteq V(G)$ and a vector of random variables distributions $(\mu_{X_1}, \dots, \mu_{X_k})$, an uncertain zone is a function $U$
$$
...
\textbf{Definition.} An uncertain environment is a tuple $(G, \{ U_i \})$, of a graph $G$ and uncertain zones $U_i$.

\input{figures/modeling}
\begin{center}
    Figure 2: The environment modeled as a graph
\end{center}
