...
\textbf{Definition.} Since each $X$ induces $Ex[X]$ on a vertex, An \textit{uncertain environment} is declared to be a tuple $(G, h:V(G) \rightarrow \mathbb{R} )$, of a digraph $G$ and a partial function $h$ labeling vertices.
